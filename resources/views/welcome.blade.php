...
<body
    ...
    <div class="max-w-2xl mx-auto glass shadow-strong p-8 mt-8 text-center">
        <img src="https://placehold.co/120x120/yellow/white?text=Logo" alt="Logo Chill Ajar"
            class="mx-auto mb-6 rounded-full shadow-lg border-4 border-amber-200">
        <h1 class="text-4xl font-extrabold mb-4 gradient bg-clip-text text-transparent">Chill Ajar Backend API
        </h1>
        <p class="text-lg text-gray-700 mb-6">Selamat datang di halaman utama backend <b>Chill Ajar</b>.<br>
            Sistem backend ini menyediakan seluruh API dan fitur utama untuk aplikasi Chill Ajar, mulai dari manajemen
            user, kursus, sesi, transaksi, hingga testimoni.<br><br>
